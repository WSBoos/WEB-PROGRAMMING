    ...
    <div class="column is-4">
      ...
      <div class="field">
        ...
        <template v-if="$v.password.$error">
            ...
            <p class="help is-danger" v-if="!$v.username.minLength">too short</p>
            <p class="help is-danger" v-if="!$v.username.maxLength">too long</p>
        </template>
      </div>
      ...
      <div class="field">
        ...
        <div class="control has-icons-left has-icons-right">
          ...
          <template v-if="$v.password.$error">
            ...
            <p class="help is-danger" v-if="!$v.password.complex">this password is invalid</p>
        </template>
        </div>
      ...
      <div class="field">
        ...
        <div class="control has-icons-left has-icons-right">
          ...
          <template v-if="$v.password.$error">
            ...
            <p class="help is-danger" v-if="!$v.confirm_password.sameAs">its not equal a password</p>
        </template>
        </div>
      ...
      <div class="field">
        ...
        <template v-if="$v.mobile.$error">
            ...
            <p class="help is-danger" v-if="!$v.first_name.maxLength">first name too long</p>
        </template>
      </div>
      ...
      <div class="field">
        ...
        <template v-if="$v.mobile.$error">
            ...
            <p class="help is-danger" v-if="!$v.last_name.maxLength">last name too long</p>
        </template>
      </div>
