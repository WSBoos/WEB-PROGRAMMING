    ...
    <section class="px-6">
      ...
      <div class="field mt-5">
        ...
        <template v-if="$v.titleBlog.$error">
          ...
          <p class="help is-danger" v-if="!$v.titleBlog.alpha">Only Letters</p>
          <p class="help is-danger" v-if="!$v.titleBlog.minLength">
            Need more then 10 letters
          </p>
          <p class="help is-danger" v-if="!$v.titleBlog.maxLength">
            Need less then 25 letters
          </p>
        </template>
      </div>
            ...
            <div class="control">
              ...
              <template v-if="$v.start_date.$error">
                <p class="help is-danger" v-if="!$v.start_date.required">
                  This field is required if end_date required
                </p>
              </template>
            </div>
          </div>
            ...
            <div class="control">
              ...
              <template v-if="$v.end_date.$error">
                <p class="help is-danger" v-if="!$v.end_date.required">
                  This field is required if start_date required
                </p>
              </template>
            </div>
          </div>
